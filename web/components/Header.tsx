  ...
  return (
    <header className="sticky top-0 z-10 text-white px-3 sm:px-6 sm:py-3" style={{ backgroundColor: 'var(--org-primary)', paddingTop: 'max(0.125rem, env(safe-area-inset-top))' }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex sm:hidden flex-col" style={{ color: 'var(--org-secondary)' }}>
          {/* Row 1: back arrow (left) + nav icons (right) */}
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              {isAdmin && (
                <Link href="/admin" className="p-0.5 hover:text-white transition-colors" title="Admin" aria-label="Admin settings">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Row 2: stallion name — full width, no competition */}
