...
export function DashboardHeader({ onPreferenceChange }: DashboardHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-10 text-white pb-0.5 sm:py-3" style={{ backgroundColor: 'var(--org-primary)', paddingTop: 'max(0.125rem, env(safe-area-inset-top))' }}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 flex items-baseline justify-between">
